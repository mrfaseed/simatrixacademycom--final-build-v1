...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('blog_posts', function (Blueprint $t) { $t->id(); $t->string('title',200); $t->string('slug',220)->unique(); $t->string('excerpt',400)->nullable(); $t->longText('content')->nullable(); $t->string('image')->nullable(); $t->string('author',120)->default('Elysium Academy'); $t->string('tag',80)->nullable(); $t->boolean('is_published')->default(true); $t->dateTime('created_at')->nullable(); });
