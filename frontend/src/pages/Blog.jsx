...
export default function Blog() {
  ...
  return (
    <>
      <PageHero eyebrow="Learn and prepare" title="Technology & Career Blog" subtitle="Practical guides that help you build skills, understand career paths and prepare for your next opportunity." />
