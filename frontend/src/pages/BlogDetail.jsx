...
export default function BlogDetail() {
  ...
  useSeo(
    post
      ? {
          title: `${post.title} | Simatrix Academy Blog`,
          ...
          jsonLd: {
            ...
            author: { "@type": "Organization", name: post.author || "Simatrix Academy" },
            publisher: { "@type": "Organization", name: "Simatrix Academy" },
            datePublished: post.created_at,
          },
        }
      : { title: "Article | Simatrix Academy Blog" }
  );
