...
export default function Branches() {
  ...
  useSeo({
    title: "Our Branches | Simatrix Academy",
    description: "Find a Simatrix Academy branch with verified addresses, phone numbers, working hours and maps.",
    canonical: "/branches",
  });
      ...
      <section className="animated-gradient relative overflow-hidden bg-gradient-to-br from-brand-800 via-brand-900 to-brand-950 py-20 text-white">
        ...
        <Section className="relative">
          ...
          <p className="reveal mt-4 max-w-2xl text-lg text-brand-100/85" style={{ "--d": "160ms" }}>
            Find a Simatrix Academy location and plan your visit.
          </p>
        </Section>
      </section>
