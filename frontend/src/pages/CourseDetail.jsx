      ...
      <Section className="relative grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_260px]">
        <div>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <a href="tel:+919677781155" className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl border border-white/20 px-6 font-bold text-white transition hover:bg-white/10"><i className="ti ti-phone" /> Talk to a counsellor</a>
          </div>
        </div>
      ...
      <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_390px]">
        ...
        <aside id="enquire" className="scroll-mt-36 lg:sticky lg:top-36">
          <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl shadow-slate-900/10">
            ...
            <div className="p-6"><EnquiryForm courses={[course]} compact /><div className="mt-5 grid grid-cols-2 gap-3 border-t border-slate-100 pt-5"><a href="tel:+919677781155" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-slate-200 text-sm font-bold text-slate-700 hover:border-brand-300"><i className="ti ti-phone" /> Call</a><a href="https://wa.me/919677781155" target="_blank" rel="noreferrer" className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-emerald-600 text-sm font-bold text-white hover:bg-emerald-700"><i className="ti ti-brand-whatsapp" /> WhatsApp</a></div></div>
          </div>
