...
export default function ResumeBuilding() {
  useSeo({
    ...
    description: "A practical guide to creating a focused, readable and ATS-friendly resume for entry-level applications.",
    canonical: "/resume-building",
  });
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Build a focused, readable resume that communicates your skills and projects clearly to recruiters."
      />
      ...
      <Section className="py-16">
        ...
        <Reveal className="relative mt-14 overflow-hidden rounded-3xl border border-[#7C3AED]/10 bg-gradient-to-br from-[#EAF1FF] via-white to-[#F3ECFF] p-10 text-center text-slate-900 shadow-sm">
          <div className="relative">
            ...
            <p className="mx-auto mt-2 max-w-xl text-slate-600">Request resume feedback, identify unclear sections and prepare to explain your projects more effectively.</p>
