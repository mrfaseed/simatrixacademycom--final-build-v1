...
const EMPTY = { title: "", tag: "", excerpt: "", content: "", image: "", author: "Simatrix Academy", is_published: true };
...
export default function ManageBlog() {
  ...
  const openEdit = (row) => {
    ...
    setForm({
      ...
      image: row.image || "", author: row.author || "Simatrix Academy", is_published: row.is_published,
    });
    setOpen(true);
  };
